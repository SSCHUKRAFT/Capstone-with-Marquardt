...
passedQuery = "SELECT passedCount, machine, employeeID, timestamp FROM passed_data_entry"
failedQuery = "SELECT failedCount, machine, employeeID, timestamp FROM failed_data_entry"
retestedQuery = "SELECT retestedCount, machine, employeeID, timestamp FROM retested_data_entry"
downtimeQuery = "SELECT downtime, esclTime, errorCode, description, machine, employeeID, timestamp FROM downtime_data_entry"
