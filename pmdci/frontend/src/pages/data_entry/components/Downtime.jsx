...
import DowntimeEdit from './DowntimeEdit';
...
const Downtime = ({machine}, {language}) => {
  ...
  return (
    <div className="everything_downtime">
      <div className="edit_window">
        <DowntimeEdit trigger={popup} setTrigger={setPopup}></DowntimeEdit>
      </div>
      <div className="downtime">
        ...
        <div className="downtime_btns">
          ...
          <div className="downtime_edit_btn">
            <Button 
              variant="contained" 
              color="warning"
              style={{ fontSize: '32px', height: '60px', width: '200px' }}
